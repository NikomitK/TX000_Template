% Das ist mein Template für die TX000 Arbeiten. Nicht perfekt, also falls ihr Verbesserungsvorschläge habt, stellt gerne einen Pull-Request. 
...
% Hab noch nicht rausgefunden, wie ich den Counter von den römischen Seitenzahlen am Anfang für das Literaturverzeichnis speichere, deshalb muss das selbst gesetzt werden.
% Bilder kommen in den images Ordner, den müsst ihr beim abrufen eines Bildes nicht angeben, passiert automatisch.

% Dieser Befehl erlaubt es, XeLaTeX nur für diese Datei zu verwenden, ohne die Build-Konfiguration (zB von TeXstudio) ändern zu müssen. 
% Siehe: https://tex.stackexchange.com/questions/235245/where-do-i-find-the-xelatex-engine-on-texstudio 
% !TeX program = xelatex
...
\renewcommand\cftchapafterpnum{\par\addvspace{12pt}}
\renewcommand\cftsecafterpnum{\par\addvspace{12pt}}
\renewcommand\cftsubsecafterpnum{\par\addvspace{8pt}}
...
Außerdem gibt es noch diese Beispieltabelle am Boden der Seite (durch [b]):
...
\pagenumbering{Roman}
% Muss noch manuell gesetzt werden, zu faul für nen fix
\setcounter{page}{7}
%Quellenverzeichnis
