...
\begin{figure}[h!]
	\begin{struktogramm}(153,55)[]
		...
		\return{Du bestehst}
		\change
		\forallin{$\forall Formkriterien \in Bewertungsbogen$}
		\sub{Schau mer mal was wird}
		\forallinend
		\return{\sFalse}
		\ifend
	\end{struktogramm}
	\caption{Filterfunktion für die Checkboxen}
	\label{fig:FilterFunktion}
\end{figure}
